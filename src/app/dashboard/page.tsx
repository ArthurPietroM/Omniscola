...
export default async function DashboardPage() {
  ...
  const periodo = turmasAtivas[0]?.periodo ?? '—';
  ...
  return (
    <div className="p-6 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        {periodo !== '—' && (
          <span className="text-xs bg-[#FDF0E8] text-[#E8601C] px-3 py-1 rounded-full">
            {periodo}
          </span>
        )}
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-[#FDF0E8] rounded-lg p-4">
          <p className="text-2xl font-medium text-[#E8601C]">
      ...
      <div className="bg-white border border-black/[.06] rounded-xl p-4">
        ...
        {todasTurmas.length === 0 ? (
          <div className="text-center py-8 text-gray-400 text-sm">
            ...
            <Link href="/turmas" className="text-[#E8601C] hover:underline">
              Criar turma
            </Link>
          </div>
        ) : (
